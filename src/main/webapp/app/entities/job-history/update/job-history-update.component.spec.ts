...
describe('JobHistory Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    it('Should call job query and add missing value', () => {
      ...
      const job: IJob = { id: 12673 };
      jobHistory.job = job;

      const jobCollection: IJob[] = [{ id: 17376 }];
    ...
    it('Should call department query and add missing value', () => {
      const jobHistory: IJobHistory = { id: 456 };
      const department: IDepartment = { id: 21509 };
      jobHistory.department = department;

      const departmentCollection: IDepartment[] = [{ id: 5627 }];
    ...
    it('Should call employee query and add missing value', () => {
      const jobHistory: IJobHistory = { id: 456 };
      const employee: IEmployee = { id: 32573 };
      jobHistory.employee = employee;

      const employeeCollection: IEmployee[] = [{ id: 24552 }];
    ...
    it('Should update editForm', () => {
      const jobHistory: IJobHistory = { id: 456 };
      const job: IJob = { id: 1983 };
      jobHistory.job = job;
      const department: IDepartment = { id: 21835 };
      jobHistory.department = department;
      const employee: IEmployee = { id: 5229 };
      jobHistory.employee = employee;
