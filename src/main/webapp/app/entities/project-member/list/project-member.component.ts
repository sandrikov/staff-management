...
export class ProjectMemberComponent implements OnInit {
  ...
  trackId = (_index: number, item: IProjectMember): number => this.projectMemberService.getProjectMemberIdentifier(item);
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.projectMembers = this.refineData(dataFromBody);
  }

  protected refineData(data: IProjectMember[]): IProjectMember[] {
