...
public class ExceptionTranslator extends ResponseEntityExceptionHandler {
    ...
    private ProblemDetailWithCause getProblemDetailWithCause(Throwable ex) {
        if (
            ex instanceof ru.otus.coursework.staff.service.EmailAlreadyUsedException ||
            ex instanceof ru.otus.coursework.staff.service.UsernameAlreadyUsedException
        ) {
        ...
        if (
            ex instanceof ru.otus.coursework.staff.service.InvalidPasswordException
