package ru.otus.projectwork.staff.web.rest.errors;
...
public class ExceptionTranslator extends ResponseEntityExceptionHandler {
    ...
    private ProblemDetailWithCause getProblemDetailWithCause(Throwable ex) {
        if (
            ex instanceof ru.otus.projectwork.staff.service.EmailAlreadyUsedException ||
            ex instanceof ru.otus.projectwork.staff.service.UsernameAlreadyUsedException
        ) {
        ...
        if (
            ex instanceof ru.otus.projectwork.staff.service.InvalidPasswordException
